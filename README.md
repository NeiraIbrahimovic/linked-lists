...
Generic and raw linked-list implementations with recovered unit tests.

## Technical depth

Pointer manipulation, traversal, and generic versus untyped APIs.
...
Use MyLinkedList or MyRawLinkedList from a Java application.
